...
public class Page {
    ...
    private Map<String, List> attr = new HashMap<String, List>(); /*不必要因素*/

    public Map<String, List> getAttr() {
        return attr;
    }

    public void setAttr(Map<String, List> attr) {
        this.attr = attr;
    }
    ...
    public Page(int nowPageNum, int totalNum, int pageSize, int pageNum, int startIndex, int startPage, int endPage, String url, List list) {
        this.nowPageNum = nowPageNum;
        this.totalNum = totalNum;
        this.pageSize = pageSize;
        this.pageNum = pageNum;
