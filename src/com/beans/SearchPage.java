...
public class SearchPage {
    ...
    public SearchPage(int nowPageNum, int totalNum, int pageSize, int pageNum, int startIndex, int startPage, int endPage, String url, List<News> list, Map attr) {
        this.nowPageNum = nowPageNum;
        this.totalNum = totalNum;
        this.pageSize = pageSize;
        this.pageNum = pageNum;
