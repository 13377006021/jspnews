...
public class UserGroupService {
    ...
    * 添加用户组
    * */
    public Map<String, java.io.Serializable> insertUserGroup(String name, String[] s){
    ...
    * 获取用户组信息
    * */
    public Map<String, java.io.Serializable> selectUserGroup(int id){
        Map<String, java.io.Serializable> tipsMap = new HashMap<String, java.io.Serializable>();
    ...
    * 更新用户组
    * */
    public Map<String, java.io.Serializable> updateUserGroup(int id, String name, String le){
        Map<String, java.io.Serializable> tipsMap = new HashMap<String, java.io.Serializable>();
