...
${pageContext.setAttribute("title","文章页")}
...
<div id="main">
    ...
    <div id="article" class="articleId_${requestScope.map.news.id}">
        ...
        <span class="returnHome">
                    <a href="/" title="点击进入新闻首页">
                        <img src="${requestScope.map.header.icourlSet}">返回新闻首页
                    </a>
                </span>
        <div class="share">
            ...
            <a class="share_twitter"><i class="fa fa-twitter"></i></a>
                    <div class="opera">
            <span id="btn">
                <i class="iconfont" >&#xe602;</i><b class="d+" id="dianzan"> ${requestScope.map.likes}</b>
            </span>
                    </div>
        </div>
                                ...
                                <li id="comments-list-${c.comments.id}">
                                    ...
                                    <div class="text" id="commentsText_${c.comments.id}">
                                        ...
                                        <div class="info">
                                            ...
                                            <a id="commentsLike_${c.comments.id}"> <span><i class="iconfont" >&#xe602;</i><d>赞</d> <b class="d+" >${c.comments.support}</b></span></a>
