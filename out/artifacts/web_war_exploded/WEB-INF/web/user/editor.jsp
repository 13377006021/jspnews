                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div class="margin-top-10 index-img">
                                            <input type="text" value="${requestScope.map.news.slideImg}" name="slideImg" id="slideImg" placeholder="首页幻灯图规格（650*307）" class="form-control">
                                                ...
                                                <div class="margin-top-10" >
                                                    <form class="form-horizontal form-bordered" role="form" id="gravaForm" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="userImg" class="col-sm-2 control-label no-padding-right">请选择图片:</label>
                                                            <div class="col-sm-10">
                                                                <input type="file" name="grava" class="form-control"  id="userImg" placeholder="图片">

                                                            </div>
                                                        </div>
                                                        <div class="form-group text-align-right">
                                                            <div class="col-sm-offset-2 col-sm-10" style="margin-top: 2em">
                                                                <a href="javascript:void(0);" class="btn btn-labeled btn-info" id="gravaSubmit">
                                                                    <i class="btn-label glyphicon glyphicon-open"></i>上传图片并保存
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </form>
