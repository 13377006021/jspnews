...
<c:if test="${pageScope.type=='login'||pageScope.type=='reg'||pageScope.type=='contacts'}">
    ...
    <script type="text/javascript" src="/app/js/ajax/contactsSave.js"></script>

    <script type="text/javascript" src="/app/js/popup.js"></script>

</c:if>
<c:if test="${pageScope.type=='retpswd'}">
    <script type="text/javascript" src="/app/js/zeroModal.min.js"></script>
    <script type="text/javascript" src="/app/js/ajax/retpassword.js"></script>
